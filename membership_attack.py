...
# gather data
TRIPS_ID_TARGETTED = pd.read_csv("./trips_id_target.csv")
...
TR_SIZE = 1                       # 1 is all the traj, 0 is none of them
TS_SIZE = 1                       # 1 is all the traj, 0 is none of them
...
def sample_data(data, nb_repeat=4, nb_instance=10):
    ...
    assert comb.shape[0] >= nb_instance
